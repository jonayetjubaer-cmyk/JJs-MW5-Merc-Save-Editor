...
Asset names follow `<VARIANT>_MDA` (confirmed from save data). The roster is the
full set of real MWMechDataAsset chassis from the game, taken from the stock-mech
template extraction contributed by FiendishDrWu (GitHub issues #2 and #6) -- so
every entry is a chassis the game can actually spawn, including later DLC (Chaos
Reign and the Clan rebuilds). The game still ignores assets from DLC you do not
own. Family names + hero nicknames are curated; tonnage/weight class are facts.
"""
...
CHASSIS = {
    ...
    'Berserker': ['BSK-1', 'BSK-2', 'BSK-3', 'BSK-5', 'BSK-6', 'BSK-7', 'BSK-AIV', 'BSK-BT'],
...
CHASSIS_TONNAGE = {
    ...
    # Clan / later-DLC chassis restored from the stock-template roster (issue #8)
    "Incubus": 30, "Bushwacker": 55, "Ebon Jaguar": 65, "Linebacker": 65,
    "Night Gyr": 75, "Naga": 80, "Sunder": 90, "Kodiak": 100,
}
