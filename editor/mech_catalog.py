...
Asset names follow `<VARIANT>_MDA` (confirmed from save data). Sourced from the
Sarna BattleTechWiki MW5 roster. The game safely ignores entries it doesn't have
(e.g. DLC you don't own): it just won't spawn that mech, the rest are unaffected.
"""

CHASSIS = {
    'Adder': ['ADR-A', 'ADR-B', 'ADR-D', 'ADR-PRIME', 'ADR-S'],
    'Annihilator': ['ANH-1A', 'ANH-1E', 'ANH-1X', 'ANH-2A', 'ANH-IR'],
    'Archer': ['ARC-2K', 'ARC-2P', 'ARC-2R', 'ARC-2RB', 'ARC-2S', 'ARC-2W', 'ARC-5CS', 'ARC-AGC', 'ARC-T'],
    'Assassin': ['ASN-101', 'ASN-21', 'ASN-25', 'ASN-26', 'ASN-27', 'ASN-DD'],
    'Atlas': ['AS7-BH', 'AS7-D', 'AS7-D-H', 'AS7-K', 'AS7-KR', 'AS7-P', 'AS7-RS', 'AS7-S'],
    ...
    'Black Knight': ['BL-6-KNT', 'BL-6B-KNT', 'BL-7-KNT', 'BL-7-KNT-L', 'BL-7-KNT-P', 'BL-P-KNT', 'BL-P-KNT2', 'BL9-KNT'],
    ...
    'Executioner': ['EXE-A', 'EXE-B', 'EXE-B-A', 'EXE-B-B', 'EXE-B-C', 'EXE-B-PRIME', 'EXE-C', 'EXE-D', 'EXE-PRIME'],
    ...
    'Gargoyle': ['GAR-A', 'GAR-B', 'GAR-C', 'GAR-D', 'GAR-P', 'GAR-PRIME'],
    ...
    'Jenner': ['JR7-D', 'JR7-F', 'JR7-II-3', 'JR7-IIC', 'JR7-IIC-2', 'JR7-IIC-A', 'JR7-IIC-FY', 'JR7-K', 'JR7-O', 'JR7-P'],
    'King Crab': ['KGC-000', 'KGC-0000', 'KGC-000B', 'KGC-001', 'KGC-CAR', 'KGC-KJ'],
    'Kintaro': ['KTO-18', 'KTO-18P', 'KTO-19', 'KTO-19B', 'KTO-20', 'KTO-GB'],
    'Kit Fox': ['KFX-AIV', 'KFX-C', 'KFX-D', 'KFX-E', 'KFX-P', 'KFX-PRIME', 'KFX-S'],
    'Kodiak': ['KDK-1', 'KDK-2', 'KDK-3', 'KDK-4', 'KDK-5', 'KDK-A', 'KDK-B', 'KDK-SB'],
    ...
    'Marauder': ['MAD-2R', 'MAD-3D', 'MAD-3L', 'MAD-3M', 'MAD-3R', 'MAD-4A', 'MAD-5A', 'MAD-5CS', 'MAD-5D', 'MAD-AH', 'MAD-BH', 'MAD-BH2', 'MAD-BH3015', 'MAD-BH3044'],
    ...
    'Nightstar': ['NSR-9J', 'NSR-9R', 'NSR-9S', 'NSR-D1'],
    ...
    'Rifleman': ['RFL-3C', 'RFL-3N', 'RFL-4D', 'RFL-5CS', 'RFL-DB', 'RFL-DNA', 'RFL-LK', 'RFL-RCX'],
    'Shadow Cat': ['SHC-A', 'SHC-B', 'SHC-M', 'SHC-P', 'SHC-PRIME'],
    'Shadow Hawk': ['SHD-1P', 'SHD-2D', 'SHD-2D2', 'SHD-2H', 'SHD-2K', 'SHD-2P', 'SHD-5M', 'SHD-GD', 'SHD-IIC', 'SHD-IIC-2', 'SHD-IIC-A', 'SHD-IIC-C', 'SHD-IIC-DT'],
    'Spider': ['SDR-5D', 'SDR-5K', 'SDR-5V', 'SDR-A', 'SDR-RCX'],
    'Stalker': ['STK-3F', 'STK-3FB', 'STK-3H', 'STK-4N', 'STK-5M', 'STK-5S', 'STK-M'],
    'Stormcrow': ['SCR-A', 'SCR-B', 'SCR-C', 'SCR-D', 'SCR-PRIME'],
    ...
    'Vulcan': ['VL-2P', 'VL-2T', 'VL-5T', 'VL-BL', 'VT-X1'],
